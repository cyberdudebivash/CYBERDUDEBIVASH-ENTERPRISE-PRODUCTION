      ...
      <header className="flex items-center justify-between px-6 h-16 border-b border-slate-800 bg-[#0c1117] shrink-0 sticky top-0 z-40 shadow-lg shadow-black/40">
        ...
        <nav className="hidden lg:flex items-center gap-1.5 bg-slate-950 p-1 rounded-lg border border-slate-900">
          ...
          >
            ...
            >
              <Shield className="w-3.5 h-3.5 text-cyan-550" /> Services <span className="text-[8px] opacity-70">▼</span>
            </button>
            {servicesDropdownOpen && (
              <div className="absolute top-full left-0 mt-1 w-56 bg-[#0c1117] border border-slate-800 rounded-lg shadow-xl shadow-black/85 p-1.5 z-50 space-y-0.5 animate-slide-up">
                {[
          ...
          >
            ...
            >
              <Cpu className="w-3.5 h-3.5 text-purple-450" /> Solutions <span className="text-[8px] opacity-70">▼</span>
            </button>
