...
Authentication, authorization, any database-backed data, any API, any assessment/questionnaire content, CRM, payments, admin portal, customer portal, AI insights, PDF generation, booking, email — all out of scope for this phase (`ROADMAP.md`). Nothing above should be read as implying progress on any of these.
