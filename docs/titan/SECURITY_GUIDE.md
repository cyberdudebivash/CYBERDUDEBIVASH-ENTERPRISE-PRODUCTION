...
| V4 — Access Control | Deny by default | ⚠️ N/A yet | No protected routes exist yet to evaluate this against (RBAC foundation is ready, not yet consumed — see Surface 2 above) |
